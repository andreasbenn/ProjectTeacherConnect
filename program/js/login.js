...
// then we create a forloop that runs if the emailInput and passwordInput is = currentUser wich is defined in the top.
...
loginKnap.onclick = function loginFunction (e) {
...
input.addEventListener("keydown",function(event) {
    if (event.keyCode === 13) {
        ...
        document.getElementById("loginKnap").click();
    }
});
